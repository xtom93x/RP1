    ...
    <div class='hlavny'><main>
      <form method=post><table>
        <tr><td><label for=nadpis>Nadpis</label></td>
          <td><input type=text size=30 maxlength=255 id=nadpis name=nadpis value='<?php if (isset($_POST['nadpis'])) echo $_POST['nadpis']; else echo $oznam['nadpis']?>' required></td></tr>
        <tr><td><label for=text>Obsah</label></td>
          <td><textarea name=text id=text cols=50 rows=20 required><?php if (isset($_POST['text'])) echo $_POST['text']; else echo $oznam['text']?></textarea></td></tr>
